...
const NavHeader = () => {
  ...
  return (
    <header className="lg:hidden border-b bg-white bg-white border-gray-200 border-opacity-70 border-solid z-10 fixed top-0 left-0 right-0 flex h-16 items-center justify-between px-5">
